...
> = {
  ...
  /**
   * @default current system timezone
   */
  timezone?: string
...
> {
  ...
  showPeriod = (from: TimelineDate, to: TimelineDate) => {
    const visibleTimeStart = from.epochMilliseconds
    const visibleTimeEnd = to.epochMilliseconds
